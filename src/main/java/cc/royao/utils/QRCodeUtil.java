...
public class QRCodeUtil {
    ...
    public static String encode(String content, String imgPath, String destPath,String fileName) 
            throws Exception { 
    	String filePath = QRCodeUtil.encode(content, imgPath, destPath,fileName,true); 
    	return filePath;
    } 
    ...
    public static String encode(String content, String destPath,String fileName) throws Exception { 
       String filePath = QRCodeUtil.encode(content, null, destPath,fileName,false); 
       return filePath;
    } 
...
//        QRCodeUtil.encode(text, "C:/Users/L/Desktop/", "images.jpg", true); 
//    }
}
