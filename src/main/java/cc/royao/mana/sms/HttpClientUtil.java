...
public class HttpClientUtil {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(String url, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(String url, Header[] headers)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(String url, Header[] headers, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(String url, Map<String, Object> parasMap)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(HttpClient client, String url)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(HttpClient client, String url, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(HttpClient client, String url, Header[] headers)
			throws HttpProcessException {
	...
	public static String send(HttpClient client, String url, Header[] headers,
			String encoding) throws HttpProcessException {
		return send(client, url, new HashMap<String, Object>(), headers,
				encoding);
	}
	 ...
	 */
	public static String send(HttpClient client, String url,
			Map<String, Object> parasMap) throws HttpProcessException {
	 ...
	 */
	public static String send(HttpClient client, String url,
			Map<String, Object> parasMap, String encoding)
			throws HttpProcessException {
	 ...
	 */
	public static String send(HttpClient client, String url,
			Map<String, Object> parasMap, Header[] headers)
			throws HttpProcessException {
		return send(client, url, parasMap, headers, Charset.defaultCharset()
				.name());
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(String url, HttpMethods httpMethod)
			throws HttpProcessException {
	...
	public static String send(String url, HttpMethods httpMethod,
			Header[] headers, String encoding) throws HttpProcessException {
		return send(url, httpMethod, new HashMap<String, Object>(), headers,
				encoding);
	}
	...
	public static String send(String url, HttpMethods httpMethod,
			Map<String, Object> parasMap, Header[] headers)
			throws HttpProcessException {
		return send(url, httpMethod, parasMap, headers, Charset
				.defaultCharset().name());
	}
	 ...
	 */
	public static String send(HttpClient client, String url,
			HttpMethods httpMethod) throws HttpProcessException {
	 ...
	 */
	public static String send(HttpClient client, String url,
			HttpMethods httpMethod, String encoding)
			throws HttpProcessException {
	 ...
	 */
	public static String send(HttpClient client, String url,
			HttpMethods httpMethod, Header[] headers)
			throws HttpProcessException {
		return send(client, url, httpMethod, headers, Charset.defaultCharset()
				.name());
	}
	 ...
	 */
	public static String send(HttpClient client, String url,
			HttpMethods httpMethod, Header[] headers, String encoding)
			throws HttpProcessException {
		return send(client, url, httpMethod, new HashMap<String, Object>(),
				headers, encoding);
	}
	...
	public static String send(HttpClient client, String url,
			...
			throws HttpProcessException {
		return send(client, url, httpMethod, parasMap, Charset.defaultCharset()
				.name());
	}
	...
	public static String send(HttpClient client, String url,
			HttpMethods httpMethod, Map<String, Object> parasMap,
			Header[] headers) throws HttpProcessException {
		return send(client, url, httpMethod, parasMap, headers, Charset
				.defaultCharset().name());
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String get(HttpClient client, String url, Header[] headers,
			String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String post(String url, Map<String, Object> parasMap,
			Header[] headers, String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String put(String url, Map<String, Object> parasMap,
			Header[] headers, String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String put(HttpClient client, String url,
			Map<String, Object> parasMap, Header[] headers, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String delete(String url, Header[] headers, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String delete(HttpClient client, String url,
			Header[] headers, String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String patch(String url, Map<String, Object> parasMap,
			Header[] headers, String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String patch(HttpClient client, String url,
			Map<String, Object> parasMap, Header[] headers, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String head(String url, Header[] headers, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String head(HttpClient client, String url, Header[] headers,
			String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String options(String url, Header[] headers, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String options(HttpClient client, String url,
			Header[] headers, String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String trace(String url, Header[] headers, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String trace(HttpClient client, String url, Header[] headers,
			String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(String url, HttpContext context)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(String url, HttpContext context, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(String url, Header[] headers, HttpContext context)
			throws HttpProcessException {
	...
	public static String send(String url, Header[] headers,
		...
		return send(url, new HashMap<String, Object>(), headers, context,
				encoding);
	}
	 ...
	 */
	public static String send(String url, Map<String, Object> parasMap,
			Header[] headers, HttpContext context) throws HttpProcessException {
		return send(url, parasMap, headers, context, Charset.defaultCharset()
				.name());
	}
	 ...
	 */
	public static String send(String url, Map<String, Object> parasMap,
			Header[] headers, HttpContext context, String encoding)
			throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String send(HttpClient client, String url, HttpContext context)
			throws HttpProcessException {
	...
	public static String send(HttpClient client, String url, Header[] headers,
			HttpContext context) throws HttpProcessException {
		return send(client, url, headers, context, Charset.defaultCharset()
				.name());
	}
	 ...
	 */
	public static String send(HttpClient client, String url,
			Map<String, Object> parasMap, HttpContext context)
			throws HttpProcessException {
		return send(client, url, parasMap, context, Charset.defaultCharset()
				.name());
	}
	 ...
	 */
	public static String send(HttpClient client, String url,
			Map<String, Object> parasMap, Header[] headers, HttpContext context)
			throws HttpProcessException {
		return send(client, url, parasMap, headers, context, Charset
				.defaultCharset().name());
	}
	...
	public static String send(HttpClient client, String url,
			Map<String, Object> parasMap, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
		return send(client, url, HttpMethods.POST, parasMap, headers, context,
				encoding);
	}
	...
	public static String send(String url, HttpMethods httpMethod,
			Header[] headers, HttpContext context) throws HttpProcessException {
		return send(url, httpMethod, headers, context, Charset.defaultCharset()
				.name());
	}
	...
	public static String send(String url, HttpMethods httpMethod,
			Map<String, Object> parasMap, HttpContext context)
			throws HttpProcessException {
		return send(url, httpMethod, parasMap, context, Charset
				.defaultCharset().name());
	}
	...
	public static String send(String url, HttpMethods httpMethod,
			Map<String, Object> parasMap, HttpContext context, String encoding)
			throws HttpProcessException {
		return send(url, httpMethod, parasMap, new Header[] {}, context,
				encoding);
	}
	...
	public static String send(String url, HttpMethods httpMethod,
			Map<String, Object> parasMap, Header[] headers, HttpContext context)
			throws HttpProcessException {
		return send(url, httpMethod, parasMap, headers, context, Charset
				.defaultCharset().name());
	}
	...
	public static String send(String url, HttpMethods httpMethod,
			Map<String, Object> parasMap, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
		return send(create(url), url, httpMethod, parasMap, headers, context,
				encoding);
	}
	 ...
	 */
	public static String send(HttpClient client, String url,
			HttpMethods httpMethod, HttpContext context)
			throws HttpProcessException {
		return send(client, url, httpMethod, context, Charset.defaultCharset()
				.name());
	}
	 ...
	 */
	public static String send(HttpClient client, String url,
			HttpMethods httpMethod, HttpContext context, String encoding)
			throws HttpProcessException {
	 ...
	 */
	public static String send(HttpClient client, String url,
			HttpMethods httpMethod, Header[] headers, HttpContext context)
			throws HttpProcessException {
		return send(client, url, httpMethod, headers, context, Charset
				.defaultCharset().name());
	}
	...
	public static String send(HttpClient client, String url,
			HttpMethods httpMethod, Map<String, Object> parasMap,
			HttpContext context) throws HttpProcessException {
		return send(client, url, httpMethod, parasMap, context, Charset
				.defaultCharset().name());
	}
	...
	public static String send(HttpClient client, String url,
			HttpMethods httpMethod, Map<String, Object> parasMap,
			Header[] headers, HttpContext context) throws HttpProcessException {
		return send(client, url, httpMethod, parasMap, headers, context,
	 ...
	 * @throws HttpProcessException
	 */
	public static String get(String url, Header[] headers, HttpContext context,
			String encoding) throws HttpProcessException {
	...
	public static String put(HttpClient client, String url,
			Map<String, Object> parasMap, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
		return send(client, url, HttpMethods.PUT, parasMap, headers, context,
				encoding);
	}
	...
	public static String patch(HttpClient client, String url,
			Map<String, Object> parasMap, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
		return send(client, url, HttpMethods.PATCH, parasMap, headers, context,
				encoding);
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String head(String url, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
	 ...
	 * @throws HttpProcessException
	 */
	public static String options(String url, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
	...
	public static String options(HttpClient client, String url,
			Header[] headers, HttpContext context, String encoding)
			throws HttpProcessException {
		return send(client, url, HttpMethods.OPTIONS, headers, context,
				encoding);
	}
	 ...
	 * @throws HttpProcessException
	 */
	public static String trace(String url, Header[] headers,
			HttpContext context, String encoding) throws HttpProcessException {
	...
	private static String execute(HttpClient client, HttpRequestBase request,
			String url, HttpContext context, String encoding)
			throws HttpProcessException {
		String body = "";
		HttpResponse response = null;
		try {
			// 执行请求操作，并拿到结果（同步阻塞）
			response = (context == null) ? client.execute(request) : client
	...
	public static String getUrlFile(String url, String filepath)
			throws HttpProcessException {
		// 创建请求对象
		HttpRequestBase request = getRequest(url, HttpMethods.GET);
		request.setHeaders(HttpHeader.custom().build());
		return downUrlFile(request,url, null, Charset.defaultCharset().name(), filepath);
	}

	private static String downUrlFile(HttpRequestBase request, String url,
			HttpContext context, String encoding, String filepath)
			throws HttpProcessException {
		HttpResponse response = null;
		try {
