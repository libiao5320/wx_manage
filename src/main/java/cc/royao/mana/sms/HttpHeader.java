...
public class HttpHeader {
	...
	public HttpHeader accept(String accept) {
		headerMaps.put(HttpReqHead.ACCEPT, new BasicHeader(HttpReqHead.ACCEPT,
				accept));
		return this;
	}
	...
	public HttpHeader acceptCharset(String acceptCharset) {
		headerMaps.put(HttpReqHead.ACCEPT_CHARSET, new BasicHeader(
				HttpReqHead.ACCEPT_CHARSET, acceptCharset));
		return this;
	}
	...
	public HttpHeader acceptEncoding(String acceptEncoding) {
		headerMaps.put(HttpReqHead.ACCEPT_ENCODING, new BasicHeader(
				HttpReqHead.ACCEPT_ENCODING, acceptEncoding));
		return this;
	}
	...
	public HttpHeader acceptLanguage(String acceptLanguage) {
		headerMaps.put(HttpReqHead.ACCEPT_LANGUAGE, new BasicHeader(
				HttpReqHead.ACCEPT_LANGUAGE, acceptLanguage));
		return this;
	}
	...
	public HttpHeader acceptRanges(String acceptRanges) {
		headerMaps.put(HttpReqHead.ACCEPT_RANGES, new BasicHeader(
				HttpReqHead.ACCEPT_RANGES, acceptRanges));
		return this;
	}
	...
	public HttpHeader authorization(String authorization) {
		headerMaps.put(HttpReqHead.AUTHORIZATION, new BasicHeader(
				HttpReqHead.AUTHORIZATION, authorization));
		return this;
	}
	...
	public HttpHeader cacheControl(String cacheControl) {
		headerMaps.put(HttpReqHead.CACHE_CONTROL, new BasicHeader(
				HttpReqHead.CACHE_CONTROL, cacheControl));
		return this;
	}
	...
	public HttpHeader connection(String connection) {
		headerMaps.put(HttpReqHead.CONNECTION, new BasicHeader(
				HttpReqHead.CONNECTION, connection));
		return this;
	}
	...
	public HttpHeader cookie(String cookie) {
		headerMaps.put(HttpReqHead.COOKIE, new BasicHeader(HttpReqHead.COOKIE,
				cookie));
		return this;
	}
	...
	public HttpHeader contentLength(String contentLength) {
		headerMaps.put(HttpReqHead.CONTENT_LENGTH, new BasicHeader(
				HttpReqHead.CONTENT_LENGTH, contentLength));
		return this;
	}
	...
	public HttpHeader contentType(String contentType) {
		headerMaps.put(HttpReqHead.CONTENT_TYPE, new BasicHeader(
				HttpReqHead.CONTENT_TYPE, contentType));
		return this;
	}
	...
	public HttpHeader expect(String expect) {
		headerMaps.put(HttpReqHead.EXPECT, new BasicHeader(HttpReqHead.EXPECT,
				expect));
		return this;
	}
	...
	public HttpHeader ifMatch(String ifMatch) {
		headerMaps.put(HttpReqHead.IF_MATCH, new BasicHeader(
				HttpReqHead.IF_MATCH, ifMatch));
		return this;
	}
	...
	public HttpHeader ifModifiedSince(String ifModifiedSince) {
		headerMaps.put(HttpReqHead.IF_MODIFIED_SINCE, new BasicHeader(
				HttpReqHead.IF_MODIFIED_SINCE, ifModifiedSince));
		return this;
	}
	...
	public HttpHeader ifNoneMatch(String ifNoneMatch) {
		headerMaps.put(HttpReqHead.IF_NONE_MATCH, new BasicHeader(
				HttpReqHead.IF_NONE_MATCH, ifNoneMatch));
		return this;
	}
	...
	public HttpHeader ifRange(String ifRange) {
		headerMaps.put(HttpReqHead.IF_RANGE, new BasicHeader(
				HttpReqHead.IF_RANGE, ifRange));
		return this;
	}
	...
	public HttpHeader ifUnmodifiedSince(String ifUnmodifiedSince) {
		headerMaps.put(HttpReqHead.IF_UNMODIFIED_SINCE, new BasicHeader(
				HttpReqHead.IF_UNMODIFIED_SINCE, ifUnmodifiedSince));
		return this;
	}
	...
	public HttpHeader maxForwards(String maxForwards) {
		headerMaps.put(HttpReqHead.MAX_FORWARDS, new BasicHeader(
				HttpReqHead.MAX_FORWARDS, maxForwards));
		return this;
	}
	...
	public HttpHeader pragma(String pragma) {
		headerMaps.put(HttpReqHead.PRAGMA, new BasicHeader(HttpReqHead.PRAGMA,
				pragma));
		return this;
	}
	...
	public HttpHeader proxyAuthorization(String proxyAuthorization) {
		headerMaps.put(HttpReqHead.PROXY_AUTHORIZATION, new BasicHeader(
				HttpReqHead.PROXY_AUTHORIZATION, proxyAuthorization));
		return this;
	}
	...
	public HttpHeader range(String range) {
		headerMaps.put(HttpReqHead.RANGE, new BasicHeader(HttpReqHead.RANGE,
				range));
		return this;
	}
	...
	public HttpHeader referer(String referer) {
		headerMaps.put(HttpReqHead.REFERER, new BasicHeader(
				HttpReqHead.REFERER, referer));
		return this;
	}
	...
	public HttpHeader upgrade(String upgrade) {
		headerMaps.put(HttpReqHead.UPGRADE, new BasicHeader(
				HttpReqHead.UPGRADE, upgrade));
		return this;
	}
	...
	public HttpHeader userAgent(String userAgent) {
		headerMaps.put(HttpReqHead.USER_AGENT, new BasicHeader(
				HttpReqHead.USER_AGENT, userAgent));
		return this;
	}
	...
	public HttpHeader warning(String warning) {
		headerMaps.put(HttpReqHead.WARNING, new BasicHeader(
				HttpReqHead.WARNING, warning));
		return this;
	}
	...
	public HttpHeader keepAlive(String keepAlive) {
		headerMaps.put(HttpReqHead.KEEP_ALIVE, new BasicHeader(
				HttpReqHead.KEEP_ALIVE, keepAlive));
		return this;
	}
	...
	public static class Headers {
		...
		public static final String CONTENT_CHARSET_ISO_8859_1 = Consts.ISO_8859_1
				.name();
