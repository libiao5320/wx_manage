...
<style>.edit,.delete{cursor:pointer;}</style>
                ...
                <div class="mainpanel">
                    ...
                    <div class="contentpanel">
                        <div class="alert alert-info">
                            ...
                            <strong>说明：</strong>用于C端商家排行榜分类设置
                        </div>
                           ...
                           <div class="panel-heading">
								...
								<div class="form-horizontal cb pt5">
									<div class="form-line">
										...
										<label class="w100 fl control-label lh20">商家分类</label>
                                        <div class="cb"></div>
									</div>
								</div>
								
								<div class="pull-right mt-30">
									<button type="button"  class="btn btn-primary btn-sm" id="addFristClass"  onClick="addFristClass()">添加分类</button>
								</div>
                            </div><!-- panel-heading -->
	...
	<script>
			...
			function addFristClass(){
			 	$("#addFristClass1").load("/storeClass/addClass.htm");
			 }
				...
				var queryParams = function(params){   //提交参数
				 ...
				 var renderTable = function(flag){
			        ...
			        $("#table").bootstrapTable({
			            method : 'get',
					    url : '/storeClass/queryAllStoreClass.ajax',
			            ...
			            columns : [ {
			             ...
			             onLoadSuccess: function(data){
			                    	$(".edit").click(function(){
			                    		$("#updateGoodClass").load("/storeClass/edit/" + $(this).attr("rowid") + ".htm");
			                    	});
