                    ...
                    <div class="panel-body">
                        <form class="form-horizontal form-bordered" id="form">
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" id="name" value="" class="form-control input-sm" name="name" required>
                                </div>
                            </div><!-- form-group -->
                            ...
                            <div class="form-group" id="singleAmountForm" style="display:none;">
                                ...
                                <div class="col-sm-7">
                                   <input type="number" id="singleAmount" value="0" class="input-sm form-control w160 fl" name="singleAmount" required><span class="lh30">元</span>
                                </div>
                            </div><!-- form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                   <input type="number" id="amount" value="" class="input-sm form-control w160 fl" name="amount" required><span class="lh30">元</span>
                                </div>
                            </div><!-- form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                   <input type="number" id="quantity" value="" class="input-sm form-control w160 fl" name="quantity" required><span class="lh30">个</span>
                                </div>
                            </div><!-- form-group -->
                            </div>
                            ...
                            <div class="form-group" style="display:none;">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" id="validityTime" value="" class="datepicker input-sm form-control w160 fl" name="validityTime" required><span class="lh30">天</span>
                                </div>
                            </div><!-- form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" id="sonValidityTime" value="" class="input-sm form-control w160 fl" name="sonValidityTime" required><span class="lh30">天</span>
                                </div>
                            </div><!-- form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="text" id="mountingTime" value="" name="mountingTime" class="datepicker input-sm form-control w160" required>
                                </div>
                            </div><!-- form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" id="orderBy" name="orderBy" value="1" class="input-sm form-control w160 fl"><span class="lh30">排序数字越小排序越靠前</span>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                	<textarea id="remark" class="form-control" name="remark" rows="5" required></textarea>
                                </div>
                            </div><!-- form-group -->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <input type="number" id="receiveNumber" name="receiveNumber" value="" class="form-control input-sm w160" required>
                                </div>
                            </div><!-- form-group -->
                            ...
                            <div class="form-group" id="storeSelect">
                                ...
                                <div class="col-sm-7">
                                	<select id="storeList" name="storeList" multiple class="select2 fl" style="width:500px;">
       			...
       			<script>
		            jQuery(document).ready(function(){
		              ...
		              $("#saveBtn").click(function(){
			              ...
			              if($("#type").val() == 'quota'){
			              	$("#singleAmount").val($("#amount").val()/$("#quantity").val());
			              }
			              ...
			              $.ajax({
								url: '/redpackets/saveRedpackets.ajax' ,
								type: 'POST',
