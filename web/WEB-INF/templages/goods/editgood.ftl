        ...
        <div class="mainpanel">
            ...
            <div class="contentpanel">
                <div class="alert alert-info">
                    ...
                    <strong>说明：</strong>编辑产品信息，完善产品信息、产品价格、 产品设置后再点击保存
                </div>
                <div class="panel panel-default">
                    ...
                    <!-- panel-heading -->
                    <form id="goodForm" action="/goods/edit.htm" method="post" class="form-horizontal form-bordered" enctype="multipart/form-data">
                        <div id="info_panel" class="panel-body">
                            <div class="panel-body nopadding">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" value="${result.goods.goodsName !''}" placeholder="" name="map[goodsName]"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea name="map[goodsIntroduce]" value="${result.goods.goodsIntroduce !'null'}" class="form-control" rows="5">${result.goods.goodsIntroduce}</textarea>
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea id="content" style='height:300px; width:100%;' name="map[contentIntroduce]"
                                                  rows="15"></textarea>
                                        <div id="introduceDiv" style="display:none;">
                                        	${result.goods.contentIntroduce}
                                        </div>
                                    </div>
                                </div>
                                <!-- form-group -->
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <textarea id="needknow" name="map[buyKnow]"
                                                  rows="15"></textarea>
                                        <div id="needknowDiv" style="display:none;">
                                        	${result.goods.buyKnow}
                                        </div>
                                    </div>
                                    <div class="col-sm-2">
                                ...
                                <!-- form-group -->
								<input type="hidden" value="${result.goods.goodsId}" name="map[goodsId]" />
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
										...
										<br>
										<img id="listImg" width="50px;" src="/imgView/readGoodImage.htm?imagePath=${result.goods.goodsImage}">
										<input type="hidden" id="mainImg" value="${result.goods.goodsImage}" name="map[goodsImage]">
                                    </div>
                                    <div class="col-sm-2">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                           <div id="imglist">
											   <#if result.goodsImgs?? && result.goodsImgs?size gt 0>

                                                    <#list result.goodsImgs as imgs >
															<img width="50px;" src="/imgView/readGoodImage.htm?imagePath=${imgs.img}" height="50px;"/>														
                                                    </#list>
                                            ...
                                            <div class="form-line">
                                                ...
                                                <#if result.storeList?? && result.storeList?size gt 0>
                                                    ...
                                                    <#list result.storeList as store >
                                                        ...
                                                        <option area="${store.areaId !''}" value="${store.storeId}">${store.storeName !'null'}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="number" name="map[showPriority]" value="${result.goods.showPriority !''}" placeholder=""
                            ...
                            <div class="panel-body nopadding">
                                ...
                                <table class="table" id="specTab">
                                    ...
                                    <tr align="right">
                                        ...
                                        <td colspan="12">
                                            <button type="button" style="display:none;" class="btn btn-danger btn-sm" onclick="addSpec();">
                                                	添加规格
                                            </button>
                                        </td>
									...
									<tr>
										<td><input type="text" placeholder="" class="form-control input-sm w50" disabled="disabled" value="${result.goods.productCode !'null'}"></td>
										<td><input type="text" placeholder="" class="form-control input-sm w50" value="${result.goods.standard !'null'}"></td>
										<td><input type="number" placeholder="" class="form-control input-sm w50" value="${result.goods.goodsPrice !'null'}"></td>
										<td><input type="number" placeholder="" class="form-control input-sm w50" value="${result.goods.goodsVip3Price !'null'}"></td>
										<td><input type="number" placeholder="" class="form-control input-sm w50" value="${result.goods.goodsVip0Price !'null'}"></td>
										<td><input type="number" placeholder="" class="form-control input-sm w50" value="${result.goods.goodsVip1Price !'null'}"></td>
										<td><input type="number" placeholder="" class="form-control input-sm w50" value="${result.goods.goodsVip2Price !'null'}"></td>
										<td><input type="number" placeholder="" class="form-control input-sm w50" value="${result.goods.recommendMoney !'null'}"></td>
										<td style="display:none"><input type="number" placeholder="" class="form-control input-sm w50" value="${result.goods.goodsVip4Price !'null'}"></td>
										<td><input type="number" placeholder="" class="form-control input-sm w50" value="${result.goods.bookDownPayment !'null'}"></td>
										<td><input type="text" placeholder="" class="form-control input-sm w50" value="${result.goods.unit !'null'}"></td>
										<td><input type="number" placeholder="" class="form-control input-sm w50" value="${result.goods.goodsStorage !'null'}"></td>
										<td><button type="button" style="display:none;" class="btn btn-primary btn-sm delspec">删除</button></td>
									</tr>
                        ...
                        <div id="set_panel" class="panel-body" style="display: none;">
                            <div class="panel-body nopadding">
								<div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="text" placeholder="" value="" name="map[beginTime]" class="datepicker form-control input-sm">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select name="map[goodsState]" id="goodsState" class="select2 w100 fl ml10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select name="map[isPtRed]" id="isPtRed" class="select2 w100 fl ml10">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                    	<#if result.goods.isDiyText?? && result.goods.isDiyText == "Y">
                                    		<input type="checkbox" id="isDiyText" checked onclick="changeIsBuyInfo(this)">姓名、电话、上门地址、时间
                                    	<#else>
                                        ...
                                        <select name="map[technicianId]" class="select2 w100">
                                        	...
                                        	<#if result.techie?? && result.techie?size gt 0>
	                                            ...
	                                            <#list result.techie as techie >
	                                                ...
	                                                <option value="${techie.techieId}" selected>${techie.techieName}</option>
								...
								<#if result.goodsSet??>
									<input type="hidden" name="map[setId]" value="${result.goodsSet.setId}">
								<#else>
									<input type="hidden" name="map[setId]" value="">
								</#if>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <input type="number" value="${result.goods.xfqYxqValues}" name="map[xfqYxqValues]" class="form-control input-sm w100">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select id="serviceShComplaint" name="map[serviceShComplaint]" class="select2 w100 fl ml10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-7">
                                        <select id="serviceShRefund" name="map[serviceShRefund]" class="select2 w100 fl ml10">
                                            <option value="0" >不支持</option>
                                            <option value="1">支持</option>
                                        </select>
                                    </div>
...
<script defer="defer">
	$("#specTab tbody tr:eq(1) td:eq(2) input").val(${result.goods.goodsPrice !'0'}/100);
	$("#specTab tbody tr:eq(1) td:eq(4) input").val(${result.goods.goodsVip0Price !'0'}/100);
	$("#specTab tbody tr:eq(1) td:eq(5) input").val(${result.goods.goodsVip1Price !'0'}/100);
	$("#specTab tbody tr:eq(1) td:eq(6) input").val(${result.goods.goodsVip2Price !'0'}/100);
	$("#specTab tbody tr:eq(1) td:eq(7) input").val(${result.goods.recommendMoney !'0'}/100);
	$("#specTab tbody tr:eq(1) td:eq(3) input").val(${result.goods.goodsVip3Price !'0'}/100);
	$("#specTab tbody tr:eq(1) td:eq(8) input").val(${result.goods.goodsVip4Price !'0'}/100);
	$("#specTab tbody tr:eq(1) td:eq(9) input").val(${result.goods.bookDownPayment !'0'}/100);
    ...
    $(function () {
		$("#clzone").val("${result.goods.gcId1 !'null'}");
		$("#clzone").select2({minimumResultsForSearch: -1});
		$("#clztwo").val("${result.goods.gcId2 !'null'}");
		$("#clztwo").select2({minimumResultsForSearch: -1});
		$("#goodsState").val("${result.goods.goodsState !'null'}");
		$("#goodsState").select2({minimumResultsForSearch: -1});
		$("#isPtRed").val("${result.goods.isPtRed !'null'}");
		$("#isPtRed").select2({minimumResultsForSearch: -1});
		$("#serviceShComplaint").val("${result.goods.serviceShComplaint !'0'}");
		$("#serviceShComplaint").select2({minimumResultsForSearch: -1});
		$("#serviceShRefund").val("${result.goods.serviceShRefund !'0'}");
		$("#serviceShRefund").select2({minimumResultsForSearch: -1});
		$("#isBook").val("${result.goods.isBook !'0'}");
		$("#isBook").select2({minimumResultsForSearch: -1});
		
		<#if result.goodsSet??>
			$("input[name='map[beginTime]']").val(stringToDate("${result.goodsSet.beginTime !'null'}"));
			$("input[name='map[endTime]']").val(stringToDate("${result.goodsSet.endTime !'null'}"));
			$("input[name='map[periodOfValidity]']").val(stringToDate("${result.goodsSet.periodOfValidity !'null'}"));
			$("select[name='map[technicianId]']").val("${result.goodsSet.technicianId !''}");
			$("select[name='map[technicianId]']").select2();
		</#if>
		
		if($("#specTab tbody > tr:eq(1) td:eq(0) input").val() == ""){
			$("#specTab tbody > tr:eq(1) td:eq(0) input").val(generateCode(10))
		}
...
//            $("#store").css("display","block");
            ...
            $("select[name='map[storeId]']").select2({minimumResultsForSearch: -1});
        });
        ...
        $("#province").val("${result.goods.areaid1 !'null'}");
		$("#province").select2({minimumResultsForSearch: -1});
		$("#province").trigger("change");
		$("#city").val("${result.goods.areaid2 !'null'}");
		$("#city").select2({minimumResultsForSearch: -1});
		$("#city").trigger("change");
		$("#area").val("${result.goods.areaid3 !'null'}");
		$("#area").select2({minimumResultsForSearch: -1});
		$("#area").trigger("change");
		$("#store").val("${result.goods.storeId !'null'}");
		$("#store").select2({minimumResultsForSearch: -1});
	...
	var generateCode = function randomString(len) {
        len = len || 32;
        var $chars = 'ABCDEFGHJKMNPQRSTWXYZabcdefhijkmnprstwxyz2345678';
        /****默认去掉了容易混淆的字符oOLl,9gq,Vv,Uu,I1****/
        var maxPos = $chars.length;
    ...
    var addGood = function () {
		...
		var imgs =  $("#imglist").find("img");
            ...
            imgs.each(function( i , o ){
                    ...
                    var img  = _o.attr("src");
                    if ( null != img && "" != img) {
                       img =  img.substring(img.indexOf("//"),img.length);
                        img = "[" +img +"]";
         ...
         if(!$("#goodsImageList").val() ||  $("#goodsImageList").val() == "")
         {
